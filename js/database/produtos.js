let produtosBd = [
    {
        ...
        preco : 'R$ 100.00',
        categoria : '<i class="fas fa-tshirt"></i>Camisetas',
        imagem : './img/Men-Jacket-Front-Black.png'
    },
    {
        nome : 'Black Hat',
        descricao : 'O gorro Next.js chegou! Esta beldade bordada tem um ajuste confortável que garante que...',
        preco : 'R$ 100.00',
        categoria : '<i class="fab fa-pied-piper-hat"></i>Acessórios',
        imagem : './img/gorro.png'
    },
    {
        nome : 'Mask',
    ...
    },
    {
        ...
        preco : 'R$ 100.00',
        categoria : '<i class="fas fa-tshirt"></i>Camisetas',
        imagem : './img/Men-TShirt-Black-Front.png'
    },
    {
        ...
        preco : 'R$ 100.00',
        categoria : '<i class="fas fa-tshirt"></i>Camisetas',
        imagem : './img/Men-TShirt-White.png'
    }
    ,
    {
